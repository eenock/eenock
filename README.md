...
>
> When I'm not in the lab, I'm **vibe coding** — building AI-assisted prototypes with agents like Claude Code and Cursor, and turning half-formed ideas into working apps at weekend speed.
### 🎯 Current Focus
<table>
  <tr>
  ...
  <tr>
    <td>⚡ Vibe Coding &amp; AI-Assisted Development</td>
    <td>🤖 AI Agents &amp; LLM-Powered Apps</td>
  </tr>
</table>
<!-- ============ RESEARCH ============ -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=rect&color=0A66C2&height=3&section=header" />
...
| ⚡ **Vibe-Coded Builds** | Rapid AI-assisted prototypes &amp; agentic workflow experiments | `Next.js` `TypeScript` `Claude Code` |
<!-- ============ PUBLIC REPOS ============ -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=rect&color=0A66C2&height=3&section=header" />
## 🚀 Public Repositories
| Project | Description |
...
- ⚡ **Vibe coder** — shipping AI-assisted prototypes and side projects at weekend speed
- 🤖 Building with **AI agents &amp; LLM-powered workflows** across the stack
<!-- ============ VIBE CODING ============ -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=rect&color=0A66C2&height=3&section=header" />
## ⚡ Vibe Coding &amp; AI-Powered Workflow
> I'm an active **vibe coder** — I describe what I want in plain language, let AI agents (Claude Code, Cursor, Copilot) generate and refactor the code, and stay in the loop for architecture, security review, and final polish. It's how most of my prototypes and weekend builds get shipped.

| Tool | How I use it |
| :--- | :----------- |
| 🧠 Claude Code / Cursor | Agentic pair-programming: scaffolding, refactors, bug-fixing, test generation |
| ✨ GitHub Copilot | Inline completions and boilerplate inside the IDE |
| 🔁 Prompt → Prototype → Review | Rapid iteration loop — ship working software in hours, not weeks |
| 🛡️ Human-in-the-Loop | AI drafts it, I verify it — especially anything security-related |

<sub>*Vibe-coding rule of thumb: let AI write the UI and the glue, but never the crypto, the auth, or the aggregation logic.*</sub>
<!-- ============ TECH STACK ============ -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=rect&color=0A66C2&height=3&section=header" />
## 🛠️ Technologies
<div align="center">
...
**AI &amp; Modern Workflow**
<img src="https://skillicons.dev/icons?i=openai,vscode,vercel,supabase" />
</div>
<!-- ============ GITHUB STATS ============ -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=rect&color=0A66C2&height=3&section=header" />
## 📈 GitHub Statistics
